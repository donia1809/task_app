...
import 'feature/auth/presentation/blocs/login/login_bloc.dart';
import 'feature/auth/presentation/blocs/otp/otp_bloc.dart';
...
Future<void> init() async {
  ...
  sl.registerFactory(() => AppBloc(getChachedAccessTokenUseCase: sl(), clearAccessTokenUseCase: sl(), cacheAccessTokenUseCase: sl(),),);
  ...
  sl.registerLazySingleton(() => GetChachedAccessTokenUseCase(sl()));
  sl.registerLazySingleton(() => ClearAccessTokenUseCase(sl()));  
  sl.registerLazySingleton(() => CacheAccessTokenUseCase(sl()));
  ...
  sl.registerLazySingleton<OtpRepo>(
    () => OtpRepoImpl(
      ...
      otpLocalDataSource: sl(),
      networkInfo: sl(),
    ),
  );
  sl.registerLazySingleton<CityRepo>(
    () => CityRepoImpl(
  ...
  sl.registerLazySingleton<AdvertisementRepo>(
    () => AdvertisementRepoImpl(
      advertisementRemoteDataSource: sl(),
      advertisementLocalDataSource: sl(),
      networkInfo: sl(),
    ),
  );
  ...
  sl.registerLazySingleton<OtpLocalDataSource>(
    () => OtpLocalDataSourceImpl(sharedPreferences: sl()),
  );
  ...
  sl.registerLazySingleton<AdvertisementRemoteDataSource>(
    () => AdvertisementRemoteDataSourceImpl(client: sl()),
  );
  sl.registerLazySingleton<AdvertisementLocalDataSource>(
    () => AdvertisementLocalDataSourceImpl(sharedPreferences: sl()),
  );
